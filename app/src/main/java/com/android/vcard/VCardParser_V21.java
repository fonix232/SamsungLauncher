...
public final class VCardParser_V21 extends VCardParser {
    ...
    public VCardParser_V21(int vcardType, String charset) {
        this.mVCardParserImpl = new VCardParserImpl_V21(vcardType, charset);
    }
