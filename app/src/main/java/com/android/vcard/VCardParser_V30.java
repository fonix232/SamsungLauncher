...
public class VCardParser_V30 extends VCardParser {
    ...
    public VCardParser_V30(int vcardType, String charset) {
        this.mVCardParserImpl = new VCardParserImpl_V30(vcardType, charset);
    }
