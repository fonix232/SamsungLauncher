...
public class VCardSourceDetector implements VCardInterpreter {
    ...
    private static Set<String> JAPANESE_MOBILE_PHONE_SIGNS = new HashSet(Arrays.asList(new String[]{"X-GNO", VCardConstants.PROPERTY_XGROUPNAME, VCardConstants.PROPERTY_X_REDUCTION}));
    ...
    public String getEstimatedCharset() {
        ...
        switch (this.mParseType) {
            ...
            case 3:
            case 4:
                return VCardConfig.IMPORT_CHARSET_SHIFTJIS;
            default:
                return null;
        }
    }
