...
class HomeSettingsUnHideAppsStateHandler extends AbstractStateHandler {
    ...
    HomeSettingsUnHideAppsStateHandler(ExecutorState stateId) {
        super(stateId);
    ...
    public void execute(StateExecutionCallback callback) {
        ...
        if (info == null) {
            ...
            this.mNlgRequestInfo = new NlgRequestInfo(this.mNlgTargetState).addScreenParam("SingleAppOrdinal", "Unhided", "yes");
            ret = 1;
        }
