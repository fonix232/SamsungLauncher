...
class AppsFolderChangeBackgroundColorSelectViewStateHandler extends AbstractAppsStateHandler {
    AppsFolderChangeBackgroundColorSelectViewStateHandler(ExecutorState stateId) {
        super(stateId);
